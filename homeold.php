        ...
        <div class="news-div">
            <div class="news-info">
                ...
                while ($news = $result->fetch_assoc()) { 
                    ...
                    <div class="news-contentdiv">
                        ...
                        <div class="news-subhdng">
                            Vignan Pharmacy has State Level Conference for the first time
                        </div>
                        <div class="news-content">
                            Pharmacy department has conducted a state level conference on <b>"Recent Trends for
                                Pharmaceutical & Applied Sciences for Global Development"</b>
                        </div>
                ...
                <div class="content">
                    ...
                    <div class="news-contentdiv">
                        ...
                        <div class="news-subhdng">
                            Vignan made a MoU with Elite Universal
                        </div>
                        <div class="news-content">
                            An agreement between Elite universal sports alliance India Pvt Ltd. and Vignan, has been
                            done on Thrusday, which benifits students in vignan to participate in National Level sports.
                        </div>
                ...
                <div class="content">
                    ...
                    <div class="news-contentdiv">
                        ...
                        <div class="news-subhdng">
                            Vignan Pharmacy made a MoU with CSC Academy
                        </div>
                        <div class="news-content">
                            An agreement between CSC Academy and Vignan Pharmacy has been done on Monday, which benifits
                            students to lean advanced technologies.
                        </div>
                ...
                <div class="content">
                    ...
                    <div class="news-contentdiv">
                        ...
                        <div class="news-content">
                            Law department has conducted a guest lecture on <b>"Corporate Legal Practice & General
                                Litigation"</b> to make students aware on Laws.
                        </div>
                ...
                <div class="content">
                    ...
                    <div class="news-contentdiv">
                        ...
                        <div class="news-content">
                            Biotech department has conducted an International guest lecture on <b>"The Future of
                                Artifical Intelligence & Engineering at Arizona State University"</b> to make students
                            aware on AI Technology.
                        </div>
            ...
            <div class="content">
                        ...
                        <div class="news-contentdiv">
                            ...
                            <div class="news-subhdng">
                                ECE Department had International Workshop
                            </div>
                            <div class="news-content">
                                One Day International Workshop on Recent Advances in
                                Fundamentals, Analysis, Design, Fabrication & Test of Advanced Antennas for Space, Air &
                                Ground Applications.
                            </div>
                    ...
                    <!-- <div class="content">
                        ...
                        <div class="news-contentdiv">
                            ...
                            <div class="news-subhdng">
                                Vignan Faculty won by Chandus Cricket Cup
                            </div>
                            <div class="news-content">
                                Vignan staff have participated in Chandus Crikcet Match and won the cup representing
                                our college.
                            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="news-contentdiv">
                            ...
                            <div class="news-subhdng">
                                Vignan Student acheived Ph.D degree
                            </div>
                            <div class="news-content">
                                G. Pruthvi Raj from Mechanical trade has completed his Ph.D and Honorable Vice
                                Chancellor P. Nagabhushan sir has awarded Ph.D certificate.
                            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="news-contentdiv">
                            ...
                            <div class="news-content">
                                Students of vignan have participated in Industry academia interaction which was
                                undertake by Agriculture and Food Sciences Technology
                            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="news-contentdiv">
                            ...
                            <div class="news-subhdng">
                                Vignan students have cleared IIT JEE Mains
                            </div>
                            <div class="news-content">
                                Students have clear iit jee mains with a high pass percentage.
                            </div>
                ...
                <div class="content">
                    ...
                    <div class="news-contentdiv">
                        ...
                        <div class="news-subhdng">
                            Women's Day Celebration in Vignan
                        </div>
                        <div class="news-content">
                            All the women staff in Vignan celebrates on the occasion of International Women's Day.
                        </div>
            ...
            <div class="news-imgdiv">
                ...
                <div class="photos">
                    ...
                    <!-- <img src="assets/images/news1-3.png"class="newsimgs"  alt="Image 3">
						<img src="assets/images/news1-4.jpg"class="newsimgs"  alt="Image 3">
						<img src="assets/images/news1-5.jpg"class="newsimgs"  alt="Image 3">-->
...
$sqlquery4 ="SELECT * FROM  events  where eve_type='academics' order by  date desc";
...
$sqlquery5 ="SELECT * FROM  notifications where notify_type='exam_notification'  order by  date desc limit 4";
        ...
        <div class="home-depts">
            ...
            <div class="deptcard_div" onclick="ecedep()" style="cursor:pointer;">
                <div class="deptcard_innrdiv">
                    ...
                    <div class="dept-imgbrdr">
                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_3079_1538" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="48" height="48">
                                <rect width="48" height="48" fill="#D9D9D9" />
                            </mask>
            ...
            <div class="deptcard_div" onclick="civildep()" style="cursor:pointer;">
                <div class="deptcard_innrdiv">
                    ...
                    <div class="dept-imgbrdr">
                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_3079_2126" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="48" height="48">
                                <rect width="48" height="48" fill="#D9D9D9" />
                            </mask>
...
?>
    ...
    <div class="home-research">
        ...
        <div class="">
            <button class="cta_button_primary Ss-btn_txt btnnone" onclick="research()">Explore More
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_2961_1144" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="-2" y="-2"
                        width="24" height="24">
                        <rect x="-2" y="-2" width="24" height="24" fill="#D9D9D9" />
        ...
        <div class="btnnone-mbl">
            <button class="cta_button_primary Ss-btn_txt  explore" onclick="research()">Explore More
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_2961_1144" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="-2" y="-2"
                        width="24" height="24">
                        <rect x="-2" y="-2" width="24" height="24" fill="#D9D9D9" />
...
?>
 ...
 <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   ...
   <!--  <script type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
    ...
    var setinterval = 12000; //time interval
    for (let i = 0; i < items.length; i++) {
        ...
        console.log(hmprogressBar.style.transition);
    ...
    function homeshowSlide(index) {
        ...
        removetransition.forEach((trns) => {
            ...
            console.log(trns.style.transition);
        });
    }

    function homenextSlide() {
        console.log('homenextSlide');
...
<path d="M19.5833 22.8333V14H22.6667V22.8333H19.5833ZM13 22.8333V14H16.0833V22.8333H13Z" fill="#992E00"/>
        ...
        if (id) {
            homenextSlide();
            pb[hm_currentIndex].childNodes[0].style.transition = "width 12s linear";
        }
    ...
    function toggleState() {
        ...
        if (toggleButton.firstChild.tagName === 'svg') {
            ...
            console.log(clearInterval(sethomeIntervalId));
...
<path d="M19.5833 22.8333V14H22.6667V22.8333H19.5833ZM13 22.8333V14H16.0833V22.8333H13Z" fill="#992E00"/>
            ...
            //   pb[hm_currentIndex].childNodes[0].style.transition = "width 12s linear";
            //     }
            //    setInterval(homenextSlide, setinterval);
        }
    }
    ...
    //  setIntervalId = undefined;
    console.log(sethomeIntervalId);
    //if(sethomeIntervalId !== undefined){
    sethomeIntervalId = setInterval(homenextSlide, setinterval);
    console.log(sethomeIntervalId);
    // }
    ...
    function research() {
        window.location.href = "https://vignan.ac.in/research.php";
    }
