                    ...
                    <div class="program-card">
                      <div class="program-card-content">
                        <div class="program-details">
                          ...
                          <div class="text_btnnew" data-toggle="modal"
                                                    ...
                                                    <div class="admsn-row1_innrdiv">
                                                        <div class="admsn-row1_sec1">
                                                            ...
                                                            <div class="admsn-row1_sec1_txtbtndiv">
                                                                <div class="admsn-row1_sec1_txt"></div>
                                                        ...
                                                        <div class="admsn-row1_sec2">
                                                            ...
                                                            <div class="admsn-row1_sec2_imgdiv">
                                                                <img class="admsn-row1_sec2_img" src="assets/images/admission_modal_pic.webp" />
                                                            </div>
                                                            <div class="admsn-row1_sec2_txtdiv">
                                                            <img src="assets/icons/quotes.png" />
                                                                <div class="admsn-row1_sec2_txt">Vignan is place a student can develop not only their professional skills but also the social awarness.</div>
                                                            
                                                                <div class="admsn-row1_sec2_name">Shalni Metturi</div>
                                                            </div>
                                                        </div>
                                                    </div>
