        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse" id="mblnav">
                <ul class="nav navbar-nav header-ul">
                    <li class="<?php if($page == 'depthome.php'){ echo 'active';} ?>"><a href="depthome.php">Home</a></li>

                   <!-- <li class=" <?php if($page == 'programstructure.php'){ echo 'active';} ?>"><a
                            href="programstructure.php">Program</a></li>-->
                  
                 
                    <li class="<?php if($page == 'deptresearch.php'){ echo 'active';} ?>"><a href="deptresearch.php">Research</a></li>
                ...
                <li class=" <?php if($page == 'deptevents.php'){ echo 'active';} ?>"><a href="deptevents.php">Events</a></li>
                ...
                <ul class="nav navbar-nav navbar-right elementnone-mbl nav-rghtdept">
                <li>
