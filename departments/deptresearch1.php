...
font-weight: 400;line-height: 140%; /* 18.2px */">Dr S.Krupanidhi</div>
                    ...
                    <button class="cta_button_primary Ss-btn_txt" onclick="window.open('deptallresearch.php?deptid=<?php echo $deptid; ?>&school=<?php echo $school;?>&deptnm=<?php echo $dptnm;?>',  '_self')">Show All Projects
...
<div class="ulife-div-29 deptfaci_big_imgcta_innrdiv">
    <img loading="lazy" src="dep_assets/images/phyreserachfacility_8.jpg" class="ulife-img-6">
    <div class="ulife-div-30">
        <div class="ulife-div-31">
            <div class="ulife-div-32 deptfaci_txt_imggap">
                Cyber Security
                <div class="smallcta_btn_primary"
                    onclick="window.open('https://vignan.ac.in/ambience.php',  '_blank')">
...
<div class="depresearchfaci_outrdiv">
    ...
    <div class="depresearchfaci_innrdiv">
        ...
        <img loading="lazy" src="dep_assets/images/machinelearning.webp" class="ulife-img-6">
            <div class="ulife-div-30">
                <div class="ulife-div-31">
                    <div class="ulife-div-32 deptfaci_txt_imggap">
                        Machine Learning
        ...
        <div style="display:flex; flex-wrap:wrap;gap:20px;    flex-direction: column;">
            ...
            <div class="ulife-div-29 deptfaci_small_imgcta_innrdiv">
                <img loading="lazy" src="dep_assets/images/virtualreality.webp" class="ulife-img-6" />
                <div class="ulife-div-30">
            ...
            <div class="ulife-div-29 deptfaci_small_imgcta_innrdiv">
                <img loading="lazy" src="dep_assets/images/artificialintell.webp" class="ulife-img-6" />
                <div class="ulife-div-30">
            <div class="ulife-div-31" style="margin-top: 0px;">
                <div class="ulife-div-32 deptfaci_txt_imggap">
   ...
   gap: 30px;flex-shrink: 0;">
        <div class="deptfaci_div2_left_title">Our Research 
Facilities</div>
        <div class="deptfaci_div2_left_desc">
            We provide cutting-edge lab facilities empower students to engage in hands-on learning
            experiences, fostering innovation and scientific exploration
        </div>
