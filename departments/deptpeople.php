    ...
    <div class="CoExAMMPCCont">
        ...
        <div class="MainAlignerForCoExAMMPC">
            <div class="CommitteeMembersSection">
                    ...
                    $sqlquery22_1 ="SELECT * FROM  profiledata where branch='".$branch."' order by empcode asc";
                ...
                while ($people = $result1->fetch_assoc()) {?>
					 <div class="CoexmmpcContributorsSectionh484w280" id="<?php echo $people['empcode'];?>" onclick="openmodal(this.id)">
						 ...
						 <?php  $img ="../../Facultyprofiles/uploads/".$people["empcode"]."/".$people["profilepic"];
														  // echo $img; echo '<br>';
 if(file_exists($img)){
				echo '<img src='.$img.' class="CoexmmpcContributorsSectionh484w280img" alt="">';
				}else{
				echo '<img src="../assets/images/personimage.png" class="CoexmmpcContributorsSectionh484w280img" alt="">';
				} ?>
                                            ...
                                            <div class="CoexmmpcContributorsSectionh484w280Detailsh92">
                                                ...
                                                <div class="CoexmmpcContributorsSectionh484w280h92h222"><?php echo $people['desig'];?></div>  <div class="CoexmmpcContributorsSectionh484w280h92h222"><?php echo 'Department of'.' '.$people['branch'];?></div>
                                            </div>
                                        </div>
				<?php }}?>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-div">
                                    <div class="prof-title">Faculty Profile
                                        ...
                                        <div class="prof-section_hdng_div">		
											<p class="fac-name" id="modalmessage"></p>	
    ...
    <script>
			   ...
			   $.ajax({
                    ...
                    success: function (response)
                    {
						...
						/*if(obj['interests'].length >0 && obj['teachingengmnts'].length>0 && obj['expeirence'].length >0 &&
						   ...
						   obj['membership'].length >0 && obj['publications'].length >0 && obj['conferences'].length >0 &&
						   obj['facultyevents'].length >0 && obj['visits'].length >0 && obj['adminpositions'].length >0){*/
							console.log("interestes length:::::::::::"+obj['interests'].length);
							console.log("teachingengmnts length:::::::::::"+obj['teachingengmnts'].length);
							console.log("expeirence length:::::::::::"+obj['expeirence'].length);
							console.log("facultyeducation length:::::::::::"+obj['facultyeducation'].length);
							console.log("research length:::::::::::"+obj['research'].length);
							console.log("awards length:::::::::::"+obj['awards'].length);
							console.log("membership length:::::::::::"+obj['membership'].length);
							console.log("publications length:::::::::::"+obj['publications'].length);
							console.log("conferences length:::::::::::"+obj['conferences'].length);
							console.log("facultyevents length:::::::::::"+obj['facultyevents'].length);
							console.log("visits length:::::::::::"+obj['visits'].length);
							console.log("adminpositions length:::::::::::"+obj['adminpositions'].length);
       ...
       const divchild1 = document.createElement("div");
						...
						if(obj['facultyevents'].length > 0){
							...
							console.log('filters');
						facultyevents.filter((element) => { console.log(element); })
							 const div = document.createElement("div");
						div.className = 'prof-content_div';
