...
<body>
  ...
  <div class="container home-div1">
    ...
    <div class="patent-section">
      <div class="patent-subhead">Research</div>
    ...
    <div class="patent-box-container">
      ...
      $sql = "SELECT * FROM patents order by to_year desc";
      ...
      ?>
          <div class="patent-box">
            <div class="pdate"><?php echo $row['from_year'] . "-" . substr($row['to_year'], 2, 2); ?></div>
            <div class="ptitle"><?php echo $row['title']; ?></div>
            <div class="pdescr"><?php echo $row['descr']; ?></div>
            <div class="pbtn">
    ...
    <?php
    $sql1 = "SELECT count(*) as total FROM patents";
  ...
  <script>
    const boxes = document.querySelectorAll('.patent-box');
