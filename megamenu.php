...
<body>
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav  navbar-right">
                    ...
                    <div class="search-box">
                        ...
                        <img src="assets/icons/cross.png"  class="cross" id="cross"  onclick="abortterm('searchterm')" />
                    </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="navbar navbar-default navbar-static-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <img src="assets/images/logo.png" class="vignan-logo" />
                <a class="navbar-brand clz-name" href="#" id="clznm"> <b class="vignan">Department Name</b><br>VIGNAN
                    UNIVERSITY</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav dept-nav">
                        ...
                        <ul class="dropdown-menu megamenu row ">
                            ...
                            <li class="col-sm-3 megamenu-div">
                                <ul class="megamenu-options">
                                    ...
                                    <li data-img="d-img1"><a href="# " class="megamenu-options">Faculty</a> </li>
                                    <li data-img="d-img2"><a href="# " class="megamenu-options">Students</a> </li>
                                    <li data-img="d-img3"><a href="# " class="megamenu-options">Alumni</a></li>
                                    <li data-img="d-img4"><a href="# " class="megamenu-options">Board of Studies</a>
                                    </li>
                            </li>
                        </ul>
                    </li>
                    <li class="col-sm-3 hoverimg">
                        <ul>
                            <li id="d-img1"><img src="assets/images/faculty_img.png" alt=""></li>
                            <li id="d-img2"><img src="assets/images/student_img.png" alt=""></li>
                            <li id="d-img3"><img src="assets/images/faculty_img.png" alt=""></li>
                            <li id="d-img4"><img src="assets/images/student_img.png" alt=""></li>
                ...
                <li><button class="applynow_secondary applynow-btn_txt">Apply Now</button></li>
                <!-- <li ><button class="applynow_secondary applynow-btn_txt">Apply Now</button></li> -->
                </ul>
                <ul class="nav navbar-right">
    ...
    <!-- Department footer start -->
    <div class="footer">

        <div class="ftr_row2">
            <div class="ftr_row2_cols">
                <div class="ftr_row2_col_hdr">Department</div>
                <div class="ftr_row2_col_optsdiv">
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Vision & Mission</a>

                        <!-- <div style="width: 1px; height: 0px; border: 1px rgba(0, 0, 0, 0) solid"></div> -->
                    </div>
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Message from HOD</a>

                    </div>
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Achievements</a>

                    </div>
                    <div style="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">News</a>
                    </div>
                    <div style="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Annoucements</a>
                    </div>
                </div>
            </div>
            ...
            <div class="ftr_row2_cols">
                <div class="ftr_row2_col_hdr">Events</div>
                <div class="ftr_row2_col_optsdiv">
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Guest Lecture</a>

                        <!-- <div style="width: 1px; height: 0px; border: 1px rgba(0, 0, 0, 0) solid"></div> -->
                    </div>
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Workshop</a>

                    </div>
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Seminar</a>

                    </div>
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Webinar</a>
            ...
            <div class="ftr_row2_cols">
                <div class="ftr_row2_col_hdr">Facilites</div>
                <div class="ftr_row2_col_optsdiv">
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Infrastructure</a>

                        <!-- <div style="width: 1px; height: 0px; border: 1px rgba(0, 0, 0, 0) solid"></div> -->
                    </div>
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Labs</a>

                    </div>
                    <div class="ftr_row2_col_opts">
                        <a href="#" class="ftr_row2_col_optstxt">Online Courses</a>
