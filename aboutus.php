          ...
          <div class="aboutus-div-66">
            <div class="column-11">
              <div class="aboutus-div-67">
                <div class="aboutus-div-68"><?php echo $row['title'] ?></div>
                ...
                <?php echo $row['descr'] ?>
                  <br />
                  <br />
                  Vignan Group of Schools were established as Vignan Tutorials in 1982
                  by Dr.L. Rathaiah who completed his postgraduation and doctoral
                  thesis on child psychology. He started Vignan High School in 1983.
                  His childhood goal of educating the people around him has resulted
                  in lakhs of students receiving quality education in his institutions
                </div>
              </div>
            </div>
            <div class="column-12">
                        ...
                        <div class="column-19">
                            <div class="acc-div-119">
                                <div class="div-120">
                                    ...
                                    <div class="text_btnnew viewall-right" data-toggle="modal"  data-target="#nba">
                                        <div class="text_btnnew_innrdiv">
                                            <div class="text_btnnew_txt">
                        ...
                        <div class="column-20">
                            <div class="acc-div-125">
                                <div class="div-126">
                                    ...
                                    <div class="text_btnnew viewall-right" data-toggle="modal"  data-target="#iqachead_dsiroverlay">
                                        <div class="text_btnnew_innrdiv">
                                            <div class="text_btnnew_txt">
                            ...
                            <div class="acc-div-119">
                                <div class="div-132">
                                    ...
                                    <div class="text_btnnew viewall-right"
                                        onclick="window.open('naac.php',  '_blank')">
                                        <div class="text_btnnew_innrdiv">
                                            <div class="text_btnnew_txt">
          ...
          <div class="aboutus-div-138">
            <div class="column-22">
              <div class="aboutus-div-139">
                ...
                <div class="aboutus-div-142" style="width:40%;">
            ...
            <div class="column">
              <div class="aboutus-div-147">
                ...
                <div class="aboutus-div-150">
                  <div class="text_btnnew viewall-right" onclick="window.open('nad.php',  '_blank')">
            <div class="text_btnnew_innrdiv">
                <div class="text_btnnew_txt">
                <?php echo $row['btn_nm1'] ?>
                </div>
...
function toggleDivContent(){
	...
	// smallScreenDiv.style.width= '100%';
