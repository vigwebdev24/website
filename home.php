...
<body>
    ...
    <div class="container home-div1">
        ...
        <?php  
        $sqlquery2 ="SELECT * FROM  sections  where id='home_goals'";
        ...
        <div class="news-div">
            <div class="news-info">
                ...
                <div class="newstxt-carousel">
                    ...
                    $all[] = $news;
                    $newsdatedb =new DateTime($news['date']);
                ...
                <div class="news-cntrlsdiv">
                    ...
                    <div class="prgrs-outrr">
                        <div id="progressBar" class="prgrs"></div>
                    </div>
        ...
        <div class="home-events">
            ...
            <div class="eventsdiv">
                <?php  if(mysqli_num_rows($result) > 0){
                while ($row = $result->fetch_assoc()) { 
                    $notf_dbdate =new DateTime($row['date']);
        ...
        ?>
        <div class="home-renowed_div1_title btnnone-mbl " id="alumni">
            Alumni Hall of Fame
        </div>
        ...
        <div class="home-emational_div">
            ...
            <div class="home-emational_div1">
                ...
                <div class="home-emational_subdv2">
                    ...
                    <div class="btnnone-mbl">
                        <button class="cta_button_primary explore" data-toggle="modal"
                        data-target="#physiologicaloverlay">
    ...
    <div class="modal fade" id="physiologicaloverlay" tabindex="-1" role="dialog" aria-labelledby = "modalLabel" aria-hidden="true">
        <div class="overlay-dialog1 less-width-overlay" role="document" style="width: 35% !important;">
            <div class="filter-modal_content2" style="padding: 20px;">
                <div class="close-section">
                    <div class="physio-header" style="font: 49px / 49px DM Serif Display, -apple-system, Roboto, Helvetica, sans-serif;">
                ...
                <div class="physio-descr" style="margin-top: 31px;font: 16px / 22px Familjen Grotesk, -apple-system, Roboto, Helvetica, sans-serif; text-align:justify;">VFSTR has implemented an exemplary student counselling program characterised by a robust and well-established system. Each faculty member is responsible for counselling a group of 20–25 students, fostering a strong and cohesive student-counsellor relationship. This arrangement allows students to freely engage with their counsellors, addressing matters related to academic achievement and future aspirations. Moreover, the psychological well-being and growth of all students are continuously monitored by a team comprising Vignan counsellors, female doctors, wardens, and chief wardens.</div>
                <div class="phsio" style="display: flex;flex-direction:column;gap:25px; margin-top:20px;">
                    <p class="member-name">Physologists to support you</p>
                    <?php 
                        $query = "SELECT * FROM `team_member` WHERE type='physiology';";
                        $result=mysqli_query($conn, $query);
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                    ?>
                        <div class="physio-details">
                            <img src="<?php echo $row['img'].".png" ?>" alt="">
                            <p class="member-name"><?php echo $row['name'];?></p>
                            <p class="member-role"><?php echo $row['role'];?></p>
                        </div>
                    <?php }}?>
                </div>
            </div>
    ...
    <!-- News Modal-->
    <div class="modal fade" id="overlaynews" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
