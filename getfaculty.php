...
//print_r($_POST);
	 ...
	 $sqlquery22_2 ="SELECT DISTINCT(interest),empcode FROM interests where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_3 ="SELECT DISTINCT(teachingengmnts),empcode FROM `teachingengmnts` WHERE empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_4 ="SELECT DISTINCT(facultyeducation),date,empcode FROM facultyeducation where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_5 ="SELECT DISTINCT(research),date,empcode FROM  research where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_6 ="SELECT DISTINCT(awards),date,empcode FROM awards where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_7 ="SELECT DISTINCT(membership),date,empcode FROM membership where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_8 ="SELECT DISTINCT(publications),date,empcode FROM publications where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_9 ="SELECT DISTINCT(conferences),date,empcode FROM conferences where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_10 ="SELECT DISTINCT(facultyevents),date,empcode FROM facultyevents where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_11 ="SELECT DISTINCT(visits),date,empcode FROM visits where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_12 ="SELECT DISTINCT(adminpositions),date,empcode FROM adminpositions where empcode='".$_POST['id']."'";
	 ...
	 $sqlquery22_13 ="SELECT DISTINCT(expeirence),location,fromdt,todt,empcode FROM expeirence where empcode='".$_POST['id']."'";
