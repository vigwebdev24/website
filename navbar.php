        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse" id="mblnav">
                <ul class="nav navbar-nav header-ul">
                    ...
                    <li class=" <?php if($page == 'uniresearch.php'){ echo 'active';} ?>"><a href="uniresearch.php">Research</a></li>
...
">
            ...
            <div class="search-box" id="search-show" style="display:none;">
                ...
                <img src="assets/icons/search_square.webp" class="search-bar-icon" />
                <input type="text" class="input-search" id="searchterm" value="" style="margin-top: 0;"
                    placeholder="What are you looking for?" onkeyup="populateList()">
                <img src="assets/icons/cross.png" class="search-bar-icon" style="cursor: pointer;" onclick="abortterm('searchterm')" />
