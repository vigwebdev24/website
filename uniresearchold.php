...
<head>
    ...
    <link rel="stylesheet" href="departments/dep_css/dept.css">
...
?>
    ...
    <div class="home-emational_div" style="margin-bottom: 150px;">
        ...
        <div class="resstat" style="margin-bottom:150px;">
        ...
        <!-- -----------------End  section Research statistics --------------------->
        <!-- -----------------start  section Funding Agencies --------------------->
        <!-- <div class="home-researchdiv" style="gap: var(--Spacing-Spacing-xl, 450px);">
                <div class="home-researchdiv1">
                    <div class="home-researchtitle">
                        Funding Agencies
                    </div>
                    <div class="home-researchtxt">
                        We believe learning should be an enjoyable experience & emphasis on
                        learning skills over exam scores. We have curated our programs in a unique style of
                        teaching,
                        which help students to recall the content that they studied in an efficient way.
                    </div>
                ...
                <div class="home-reseach_square">
                    <div class="home-reseach_square_innrdiv">
                        <div class="home-reseach_square_content">
                            <div class="home-reseach_square_txt">
                                153<small class="home-reseach_circle_small">+</small>
                            </div>
                            <div class="home-reseach_square_title">
                                Research Patents
                            </div>
...
<!-- -----------------End  section Funding Agencies --------------------->



                <!-- Explore facilities starts here -->

                <div class="explore_facilidiv" style="width:100%;margin-bottom: 40px;">

<div class="explore_facili_leftdiv">

    <div class="explore_facili_leftupprdiv">
        <div class="hdng">Explore Facilities to Support you</div>
        <div class="contnt">At our college, department-level facilities are designed to foster an optimal
            learning environment. From state-of-the-art laboratories equipped with cutting-edge technology
            to collaborative study spaces, we provide students with the resources needed to excel in their
            academic pursuits and cultivate innovative ideas within their respective departments</div>
    </div>

    <div class="explore_facili_leftlwrdiv">
        <img class="explore_facili_leftlwrdiv_img1" src="assets/images/uniresearch-explorefac_img1.webp" alt=""
            srcset="">
        <img class="explore_facili_leftlwrdiv_img2" src="assets/images/uniresearch-explorefac_img2.webp" alt=""
            srcset="">
    </div>
...
<div class="explore_facili_rightdiv">
    <img class="explore_facili_rightdiv_img" src="assets/images/uniresearch-explorefac_img3.webp" alt="" srcset="">
    <div class="explore_facili_right_imgbtndiv">
        <img class="explore_facili_rightdiv_img2" src="assets/images/uniresearch-explorefac_img4.webp" alt=""
            srcset="">
...
<!-- Explore facilities ends here -->
        ...
        <div class="pab" style="margin-bottom:150px;">
                    <?php  $sqlquery11 ="SELECT * FROM  sections  where id='unires_sec11'";
            ...
            <div class="pabframe">
                ...
                <div class="pabinn">
                    ...
                    <!-- <div class="pab-knowmore">Know more</div> -->
                    <div class="text_btnnew viewall-right" onclick="window.open('your_link_here', '_blank')">
                        <div class="text_btnnew_innrdiv">
        ...
        <!----------------------End Section Policies and Board--------------------------------------->
    ...
    <!-- </div> spcae closing -->
        <!----------------------End Section downloads--------------------------------------->
            ...
            <div class="applytitle">
                ...
                <button class="cta_button_primary Ss-btn_txt bsn1"><?php echo  $goals13['btn_nm1']; ?> <img
                                src="assets/icons/Button_forwardarrow.png" /></button>
                <button class="mblbutton_secondary mblbtn_txt bsn2"><?php echo  $goals13['btn_nm2']; ?></button>
            </div>
            <div class="appmed1">
