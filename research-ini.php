...
<body>
  ...
  <div class="container home-div1">
    ...
    <div class="patent-box-container">
      ...
      <?php
      $sql = "SELECT * FROM researchs where id like 'research_ini_card%'";
      ...
      ?>
          <div class="patent-box">
            <div class="rname"><?php echo $row['researcher_name']; ?></div>
            <div class="rdescr"><?php echo $row['topic']; ?></div>
            <div class="pbtn">
    ...
    <?php
    $sql1 = "SELECT count(*) as total FROM researchs where id like 'research_ini_card%'";
