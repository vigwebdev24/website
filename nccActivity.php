...
<body>
  ...
  $sql = "SELECT * FROM cards WHERE id LIKE 'ncc_act_cd%' ORDER BY CAST(SUBSTRING(id, 11) AS UNSIGNED)";
  $sql1 = "SELECT * FROM cards WHERE id LIKE 'ncc_act_cd1'";
  ...
  if ($result->num_rows > 0) {
   ...
   ?>
    ...
    <?php
$sql = "SELECT * FROM cards WHERE id LIKE 'ncc_act_ani_cd%' ORDER BY CAST(SUBSTRING(id, 15) AS UNSIGNED)";
